...
from .api.openfusion import router as openfusion_router
...
app.include_router(openfusion_router, prefix="/v1")
...
app.include_router(openfusion_router, prefix="/api/v1")
...
async def playground_redirect():
    ...
    return RedirectResponse("/admin/playground")
